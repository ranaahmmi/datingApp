...
class _VideoCallsGroupScreenState extends State<VideoCallsGroupScreen> {
  ...
  initRenderers() async {
    ...
    _bigRenderer.mirror = true;
    _bigRenderer.objectFit = RTCVideoViewObjectFit.RTCVideoViewObjectFitCover;
  }
  ...
  _connect() async {
    ...
    _signaling.onStreamListUpdate = ((streams) async {
      //todo figure out why small video duplicates
      print(
          ...
          _isCallActive
              ? Positioned(
                  ...
                  child: Container(
                    ...
                    child: RTCVideoView(_bigRenderer),
...
//        _listOfStreams.removeAt(index);
      ...
      child: Card(
        ...
        child: Container(
            ...
            child: ClipRRect(
                borderRadius: BorderRadius.circular(25),
                child: RTCVideoView(_listOfSmallRenderers[index]))),
      ),
    );
  }
}
